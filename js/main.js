(function($) {
    ...
    $(function() {
        ...
        $('.loadmore').on('click', 'a', function(e) {
            ...
            if (_set.length) {
                ...
                _this.text('No more Courses to display');
            }
    ...
    /*-------------------------------------
     ...
     --------------------------------------*/
    $('nav#dropdown').meanmenu({ siteLogo: "<a href='index.php' class='logo-mobile-menu' ><img src='img/jplogo.png' style=' max-width: 80%;'/></a>" });
